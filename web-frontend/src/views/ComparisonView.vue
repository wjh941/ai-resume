...
async function compare(): Promise<void> {
  ...
  comparing.value = true; error.value = ""; needsMembership.value = false
...
<template>
  <section class="view-layout comparison-view">
    ...
    <template v-else>
      <ComparisonRolePicker v-model:selected="selected" :roles="roles" :max-selectable="4" @submit="compare" />
