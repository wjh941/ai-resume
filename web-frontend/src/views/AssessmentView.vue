...
async function submit(): Promise<void> {
  if (!complete.value || saving.value) { error.value = complete.value ? "" : "请完成全部题目后提交"; return }
...
<template>
  <section class="view-layout assessment-view">
    ...
    <p v-if="error" class="notice-error" role="alert">{{ error }}</p><p v-if="notice" class="source-notice">{{ notice }}</p>
