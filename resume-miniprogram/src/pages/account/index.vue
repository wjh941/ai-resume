...
<style scoped>
.page { min-height: 100vh; box-sizing: border-box; padding: 28rpx; background: #f4f7fb; }.profile-card,.section { padding: 26rpx; background: #fff; border: 1rpx solid #e1eaf4; border-radius: 18rpx; box-shadow: 0 8rpx 22rpx rgba(35, 78, 130, .06); }.title,.meta,.section-title,.error,.scope-copy,.policy-hint,.acknowledgement { display: block; }.title { color: #1f2937; font-size: 38rpx; font-weight: 700; }.meta { margin-top: 10rpx; color: #718096; font-size: 23rpx; word-break: break-all; }.error { margin-top: 12rpx; color: #bf3f3a; font-size: 23rpx; }.section { margin-top: 20rpx; }.section-title { color: #334155; font-size: 29rpx; font-weight: 700; }.section button { margin-top: 14rpx; color: #1d4ed8; background: #edf6ff; border: 1rpx solid #cfe4fb; text-align: left; font-size: 25rpx; }.scope-copy,.policy-hint { margin-top: 10rpx; color: #64748b; font-size: 23rpx; line-height: 1.55; }.policy-hint { color: #3b6389; overflow-wrap: anywhere; }.danger-inline { color: #bf3f3a !important; background: #fdf1ef !important; border-color: #ffccc7 !important; }.acknowledgement { margin-top: 14rpx; color: #16866a; font-size: 23rpx; }.danger { margin-top: 24rpx; color: #bf3f3a; background: #fdf1ef; border: 1rpx solid #ffccc7; }
