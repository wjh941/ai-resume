...
<style scoped>
.page { min-height: 100vh; box-sizing: border-box; padding: 28rpx; background: #f4f7fb; }.status-card,.demo-card,.package-card { margin-top: 20rpx; padding: 26rpx; background: #fff; border: 1rpx solid #e1eaf4; border-radius: 18rpx; box-shadow: 0 8rpx 22rpx rgba(35, 78, 130, .06); }.status-card { margin-top: 0; }.eyebrow,.title,.copy,.section-title,.error,.notice,.capability-notice,.package-name,.price,.benefit { display: block; }.eyebrow { color: #2563eb; font-size: 21rpx; font-weight: 700; }.title { margin-top: 10rpx; color: #1f2937; font-size: 38rpx; font-weight: 700; text-transform: capitalize; }.copy { margin-top: 10rpx; color: #64748b; font-size: 23rpx; line-height: 1.55; }.section-title,.package-name { color: #334155; font-size: 29rpx; font-weight: 700; }.package-card { border-color: #dbe9f8; }.price { margin-top: 12rpx; color: #2563eb; font-size: 40rpx; font-weight: 700; }.benefit { margin-top: 10rpx; color: #52677d; font-size: 23rpx; }.package-card button,.demo-card button { margin-top: 20rpx; color: #1d4ed8; background: #edf6ff; border: 1rpx solid #cfe4fb; font-size: 24rpx; }.primary { color: #fff !important; background: #2563eb !important; border-color: #2563eb !important; }.error,.notice,.capability-notice { margin-top: 18rpx; font-size: 24rpx; text-align: center; }.error { color: #bf3f3a; }.notice,.capability-notice { color: #64748b; }.history { margin-top: 24rpx; }.history-row { display: flex; justify-content: space-between; gap: 16rpx; padding: 16rpx 0; color: #52677d; border-bottom: 1rpx solid #e1eaf4; font-size: 22rpx; }.history-row text { min-width: 0; overflow-wrap: anywhere; }
</style>
