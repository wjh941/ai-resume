  ...
  <scroll-view class="page" scroll-y>
    <view class="content">
      ...
      <template v-else-if="result">
        ...
        <view v-for="item in result.items" :key="item.role.roleName" class="role-card comparison-card">
          <view class="role-top">
            <view>
...
.hero { background: linear-gradient(145deg,#e7f1ff,#f9fcff); }.eyebrow { display: block; color: #2563eb; font-size: 21rpx; font-weight: 700; letter-spacing: 1rpx; }.title { display: block; margin-top: 10rpx; font-size: 44rpx; font-weight: 700; }.subtitle { display: block; margin-top: 12rpx; color: #64748b; font-size: 25rpx; line-height: 1.6; }
.target-card,.common-card,.role-card,.error-card,.loading { margin-top: 20rpx; }.target-card { display: flex; justify-content: space-between; gap: 16rpx; color: #1d4ed8; background: #eef8ff; border-color: #c7e5ff; font-size: 26rpx; font-weight: 700; }.error-card,.loading { padding: 28rpx; color: #8f341e; background: #fdf1ef; border: 1rpx solid #ffd8bf; border-radius: 16rpx; line-height: 1.55; }.loading { color: #59728d; background: #fff; border-color: #e3edf8; }
.section-title { display: block; color: #1d4ed8; font-size: 30rpx; font-weight: 700; }.bullet { display: block; margin-top: 12rpx; color: #4e5969; font-size: 24rpx; line-height: 1.5; }
.role-top { display: flex; justify-content: space-between; align-items: center; gap: 16rpx; }.role-name { display: block; font-size: 34rpx; font-weight: 700; }.role-family { display: block; margin-top: 7rpx; color: #86909c; font-size: 22rpx; }.score { min-width: 90rpx; height: 90rpx; display: flex; flex-direction: column; justify-content: center; align-items: center; color: #2563eb; background: #e8efff; border-radius: 50%; }.score text:first-child { font-size: 32rpx; font-weight: 700; }.score text:last-child { font-size: 19rpx; }
.description,.notice { display: block; margin-top: 16rpx; color: #64748b; font-size: 24rpx; line-height: 1.6; }.chip-row { display: flex; flex-wrap: wrap; gap: 10rpx; margin-top: 16rpx; }.chip { padding: 7rpx 12rpx; border-radius: 999rpx; font-size: 22rpx; }.positive { color: #2563eb; background: #e8efff; }.gap { display: block; margin-top: 14rpx; color: #bf3f3a; font-size: 24rpx; }
.score-list { padding: 12rpx 0; }.score-list text,.plan-section text { display: block; margin-top: 8rpx; color: #5f6f82; font-size: 22rpx; line-height: 1.5; }.risk { margin-top: 12rpx; padding: 14rpx; color: #8a5a00; background: #fffbe8; border-radius: 12rpx; font-size: 22rpx; line-height: 1.5; }.plan-section { margin-top: 16rpx; padding: 16rpx; background: #f8fafc; border-radius: 12rpx; }.plan-section text:first-child { margin-top: 0; color: #1d4ed8; font-size: 25rpx; font-weight: 700; }
button { margin-top: 20rpx; border-radius: 12rpx; font-size: 26rpx; }.primary { color: #fff; background: #2563eb; }.notice { padding: 4rpx 6rpx; font-size: 21rpx; }
