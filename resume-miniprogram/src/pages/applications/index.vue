...
.summary-card,.card { margin-top: 20rpx; padding: 24rpx; background: #fff; border: 1rpx solid #e5e6eb; border-radius: 18rpx; box-shadow: 0 8rpx 22rpx rgba(31,35,41,.04); }.summary-card { display: flex; align-items: center; justify-content: space-between; gap: 16rpx; background: #eef8ff; border-color: #c7e5ff; }.summary-number,.summary-label { display: block; }.summary-number { color: #2563eb; font-size: 42rpx; font-weight: 700; }.summary-label { margin-top: 2rpx; color: #59728d; font-size: 23rpx; }.pending { display: flex; align-items: center; gap: 10rpx; color: #8a5a00; font-size: 22rpx; }.pending button { margin: 0; color: #2563eb; background: #fff; font-size: 21rpx; }
...
button { margin-top: 20rpx; border-radius: 12rpx; }.primary { color: #fff; background: #2563eb; }.secondary { margin-top: 0; color: #4e5969; background: #f2f3f5; }.danger { margin-top: 0; color: #bf3f3a; background: #fdf1ef; }.linked-draft { display: block; margin-top: 12rpx; color: #86909c; font-size: 21rpx; }
.filter-row { display: flex; flex-wrap: wrap; gap: 10rpx; margin-top: 22rpx; }.filter-chip { margin: 0; padding: 8rpx 14rpx; color: #607286; background: #edf2f7; border-radius: 999rpx; font-size: 22rpx; }.filter-chip.active { color: #fff; background: #2563eb; }.empty,.error { display: block; margin-top: 20rpx; padding: 28rpx 22rpx; color: #86909c; background: #fff; border: 1rpx dashed #d9e0e8; border-radius: 16rpx; font-size: 24rpx; line-height: 1.6; text-align: center; }.error { color: #b3422a; background: #fdf1ef; border-color: #ffd8bf; }
.empty-illustration { display: flex; flex-direction: column; gap: 8rpx; width: 116rpx; margin: 0 auto 20rpx; padding: 20rpx; background: #eef6ff; border: 1rpx solid #d4e8ff; border-radius: 18rpx; }.empty-illustration view { height: 9rpx; background: #9fc8f7; border-radius: 999rpx; }.empty-illustration view:nth-child(2) { width: 76%; }.empty-illustration view:nth-child(3) { width: 54%; }.empty-helper { display: block; margin-top: 10rpx; color: #86909c; font-size: 23rpx; }.empty-action { margin: 20rpx auto 0; color: #fff; background: #2563eb; font-size: 24rpx; }
.record-card { padding: 22rpx; }.record-role,.record-company { display: block; }.record-role { color: #1f2329; font-size: 29rpx; font-weight: 700; }.record-company { margin-top: 6rpx; color: #86909c; font-size: 22rpx; }.status { flex-shrink: 0; padding: 7rpx 12rpx; color: #2563eb; background: #e8efff; border-radius: 999rpx; font-size: 21rpx; }.detail,.next-action { display: block; margin-top: 12rpx; color: #4e5969; font-size: 23rpx; line-height: 1.55; }.next-action { color: #a56727; }.actions { justify-content: flex-end; margin-top: 18rpx; }.actions button { min-width: 110rpx; }
.interview-filter { margin-top: 20rpx; }.interview-panel { margin-top: 20rpx; padding: 22rpx; background: #eef8ff; border: 1rpx solid #c7e5ff; border-radius: 16rpx; }.panel-title,.panel-item { display: block; }.panel-title { color: #1d4ed8; font-size: 28rpx; font-weight: 700; }.panel-item { margin-top: 10rpx; color: #4e6682; font-size: 23rpx; line-height: 1.5; }.reminder-row { display: flex; align-items: center; gap: 12rpx; margin-top: 20rpx; }.reminder-row input { flex: 1; }.reminder-row button { flex-shrink: 0; }.timeline-list { margin-top: 16rpx; padding-top: 14rpx; border-top: 1rpx solid #e8edf3; }.timeline-item { display: block; margin-top: 8rpx; color: #5f6f82; font-size: 22rpx; line-height: 1.5; }.timeline-editor { display: grid; gap: 12rpx; margin-top: 16rpx; }.timeline-editor textarea { min-height: 90rpx; }.timeline-editor button { justify-self: start; margin-top: 0; }.picker-row { display: flex; flex-wrap: wrap; align-items: center; gap: 12rpx; }.picker-row picker { flex: 1; }.picker-clear { color: #1d4ed8; font-size: 24rpx; padding: 0 8rpx; }
...
@media (hover: hover) { .record-card:hover { border-color: #c7ddf6; box-shadow: var(--ui-card-hover-shadow); } }
</style>
